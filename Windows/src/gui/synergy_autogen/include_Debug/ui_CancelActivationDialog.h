...
public:
    ...
    void retranslateUi(QDialog *CancelActivationDialog)
    {
        ...
        label->setText(QCoreApplication::translate("CancelActivationDialog", "Are you sure?\n"
"\n"
"If you don't activate Synergy you'll be missing out on some great features.", nullptr));
        label_2->setText(QCoreApplication::translate("CancelActivationDialog", "<html><head/><body><p><a href=\"https://symless.com/pricing?source=gui\"><span style=\" text-decoration: underline; color:#0000ff;\">Buy now</span></a></p></body></html>", nullptr));
    } // retranslateUi
