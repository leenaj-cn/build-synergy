...
QT_MOC_LITERAL(4, 38, 17) // "screenNameChanged"

    },
    "AppConfig\0sslToggled\0\0zeroConfToggled\0"
    "screenNameChanged"
};
...
void AppConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AppConfig::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppConfig::screenNameChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void AppConfig::screenNameChanged()const
{
    QMetaObject::activate(const_cast< AppConfig *>(this), &staticMetaObject, 2, nullptr);
}
QT_WARNING_POP
